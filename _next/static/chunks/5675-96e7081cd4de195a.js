        ...
        28045: function(e, t, i) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                var t = e.src,
                    ...
                    B = void 0 === W ? "empty" : W,
                    M = e.blurDataURL,
                    Z = s(e, ["src", "sizes", "unoptimized", "priority", "loading", "lazyRoot", "lazyBoundary", "className", "quality", "width", "height", "style", "objectFit", "objectPosition", "onLoadingComplete", "placeholder", "blurDataURL"]),
                ...
                if (function(e) {
                    ...
                    if (M = M || J.blurDataURL, T = J.src, (!F || "fill" !== F) && (q = q || J.height, L = L || J.width, !J.height || !J.width)) throw new Error("An object should only be passed to the image component src parameter if it comes from a static image import. It must include height and width. Received ".concat(JSON.stringify(J)))
                }
                ...
                var ye = t;
                0;
                var be, ve = "imagesrcset",
                    we = "imagesizes";
                ve = "imageSrcSet", we = "imageSizes";
                var ze = (n(be = {}, ve, pe.srcSet), n(be, we, pe.sizes), n(be, "crossOrigin", V.crossOrigin), be),
                ...
                return d.default.createElement(d.default.Fragment, null, d.default.createElement("span", {
                    ...
                    "aria-hidden": !0,
                    src: K
                }) : null) : null, d.default.createElement(j, Object.assign({}, ke))), p ? d.default.createElement(u.default, null, d.default.createElement("link", Object.assign({
